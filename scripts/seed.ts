...
const CHANNELS: SeedChannel[] = [
  // Sports
  { id: 'ch-sports-1', name: 'Global Sports Network', category: 'sports', language: 'en', country: 'US', isVerified: true, logoEmoji: '🏆', description: 'Live matches, highlights & analysis from around the world.' },
  ...
  // News
  { id: 'ch-news-1', name: 'World News 24', category: 'news', language: 'en', country: 'US', isVerified: true, logoEmoji: '🌍', description: 'Breaking news from every continent.' },
  ...
  // Movies
  { id: 'ch-movies-1', name: 'Cinema Classics', category: 'movies', language: 'en', country: 'US', isVerified: true, logoEmoji: '🎬', description: 'Golden-age Hollywood, restored.' },
  ...
  // Documentaries
  { id: 'ch-doc-1', name: 'Nature Wild', category: 'documentaries', language: 'en', country: 'US', isVerified: true, logoEmoji: '🦁', description: 'Wildlife from every biome.' },
  ...
  // Kids
  { id: 'ch-kids-1', name: 'Kids Cartoon Plus', category: 'kids', language: 'en', country: 'US', isVerified: true, logoEmoji: '🧸', description: 'Safe, fun cartoons for little ones.' },
  ...
  // Music
  { id: 'ch-music-1', name: 'MTV-style Hits', category: 'music', language: 'en', country: 'US', isVerified: true, logoEmoji: '🎵', description: "Today's biggest pop hits." },
  ...
  for (const c of CHANNELS) {
    await db.channel.upsert({
      ...
      create: {
        ...
        streamUrl: `https://stream.glasstv.example/${c.id}/playlist.m3u8`,
      },
      update: {
        name: c.name,
        category: c.category,
